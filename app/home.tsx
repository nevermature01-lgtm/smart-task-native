                ...
                <>
                    ...
                    <View>
                        ...
                        <View style={styles.actionsSlider}>
                            <TouchableOpacity onPress={() => router.push({ pathname: '/leads', params: { stage: 'Stage 1' }})}>
                                <ActionButton icon="layers" label="Stage 1" color="#ec4899" bg="#fce7f3" />
                            </TouchableOpacity>
                            <Feather name="arrow-right" size={16} color="#9CA3AF" />
                            <TouchableOpacity onPress={() => router.push({ pathname: '/leads', params: { stage: 'Stage 2' }})}>
                                <ActionButton icon="user" label="Stage 2" color="#a78bfa" bg="#f5f3ff" />
                            </TouchableOpacity>
                            <Feather name="arrow-right" size={16} color="#9CA3AF" />
                            <TouchableOpacity onPress={() => router.push({ pathname: '/leads', params: { stage: 'Stage 3' }})}>
                                <ActionButton icon="clipboard" label="Stage 3" color="#60a5fa" bg="#eff6ff" />
                            </TouchableOpacity>
                            <Feather name="arrow-right" size={16} color="#9CA3AF" />
                            <TouchableOpacity onPress={() => router.push({ pathname: '/leads', params: { stage: 'Stage 4' }})}>
                        ...
                        <View style={styles.actionsSlider}>
                            <TouchableOpacity onPress={() => router.push({ pathname: '/leads', params: { stage: 'Stage 8' }})}>
                                <ActionButton icon="archive" label="Stage 8" color="#EF4444" bg="#FEE2E2" />
                            </TouchableOpacity>
                            <Feather name="arrow-left" size={16} color="#9CA3AF" />
                            <TouchableOpacity onPress={() => router.push({ pathname: '/leads', params: { stage: 'Stage 7' }})}>
                                <ActionButton icon="check-square" label="Stage 7" color="#8B5CF6" bg="#EDE9FE" />
                            </TouchableOpacity>
                            <Feather name="arrow-left" size={16} color="#9CA3AF" />
                            <TouchableOpacity onPress={() => router.push({ pathname: '/leads', params: { stage: 'Stage 6' }})}>
                                <ActionButton icon="briefcase" label="Stage 6" color="#F59E0B" bg="#FEF3C7" />
                            </TouchableOpacity>
                            <Feather name="arrow-left" size={16} color="#9CA3AF" />
                             <TouchableOpacity onPress={() => router.push({ pathname: '/leads', params: { stage: 'Stage 5' }})}>
